...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BoutiqueFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/PartenariatFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProjetFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\BoutiqueFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\PartenariatFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProjetFixtures(), 'groups' => []]]);
